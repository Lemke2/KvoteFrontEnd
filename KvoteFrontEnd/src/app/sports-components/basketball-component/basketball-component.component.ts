...
@Component({
  selector: 'app-basketball-component',
  templateUrl: './basketball-component.component.html',
  styleUrls: ['./basketball-component.component.css']
})
export class BasketballComponentComponent {
  ...
  ngOnInit() {
    ...
    this.sharedDataService.toggleLeagueDisplay("Basketball");

...
@Component({
  selector: 'app-tennis-component',
  templateUrl: './tennis-component.component.html',
  styleUrls: ['./tennis-component.component.css']
})
export class TennisComponentComponent {
  ...
  ngOnInit() {
    ...
    this.sharedDataService.toggleLeagueDisplay("Tennis");

...
@Component({
  selector: 'app-football-component',
  templateUrl: './football-component.component.html',
  styleUrls: ['./football-component.component.css']
})
export class FootballComponentComponent {
  ...
  ngOnInit() {
    ...
    this.sharedDataService.toggleLeagueDisplay("Football");
    ...
    this.subscriptions.add(
      this.sharedDataService.sortedMatchBoolean$.subscribe(sort => {
        this.sortMode = sort;
      })
    );
  }
